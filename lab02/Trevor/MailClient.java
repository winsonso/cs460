...
*    Trevor Larson
* Summary:
*    This program will create a simple mail GUI with From, To, Subject,
*    and Message boxes that the user can type in to send a simple email.
*    it will also be able to recognize and recover from invalid email
*    addresses.
****************************************************************************/
...
class SMTPConnection
{
   ...
   public SMTPConnection(Envelope envelope) throws IOException
   {
      ...
      // Get the response and compare the code
      ...
      // get the local host name and continue handshake
   ...
   {
      // send each section of the email
   ...
   private void sendCommand(String command, int rc) throws IOException
   {
      ...
      // Store reply in a String and compare
      String response = fromServer.readLine();
      ...
      // Display status
      System.out.println("Client received reply: " + rc);
   ...
   {
      // Get the code and convert it to an integer
      StringTokenizer parse = new StringTokenizer(reply, " ");
      int code = Integer.parseInt(parse.nextToken());
      return code;
   }
